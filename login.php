...
<body>
    <div class="login-container">
        <div class="card login-card">
            ...
            <img src="assets/images/img_login.jpg" alt="Gambar Login">

            <div class="card-body">
                <h4 class="text-center">Login</h4>
                <p class="login-box-msg text-center">Silahkan login sebagai <b class="text-success">Dokter</b> untuk melanjutkan</p>

                <form action="pages/login/checkLogin.php" method="post" class="login-form">
                ...
                <div class="text-center mt-3">
                    <p>Login Sebagai <a href="loginUser.php"><span class="text-primary">Pasien</span></a></p>
                </div>
            </div>
        </div>
    </div>
