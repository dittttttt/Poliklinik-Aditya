                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    ?>
                                         <tr>
                                            ...
                                            <?php
                                                require 'config/koneksi.php';
                                                $cekJadwalPeriksa = "SELECT * FROM daftar_poli INNER JOIN jadwal_periksa ON daftar_poli.id_jadwal = jadwal_periksa.id WHERE jadwal_periksa.id_dokter = '$id_dokter' AND daftar_poli.status_periksa = '0' AND jadwal_periksa.is_deleted = '0'";
                                                $queryCekJadwal = mysqli_query($mysqli, $cekJadwalPeriksa);
                                                if (mysqli_num_rows($queryCekJadwal) > 0) { ?>
                                                <button type='button' class='btn btn-sm btn-warning edit-btn'
                                                    data-toggle="modal" data-target="#editModal<?php echo $data['id'] ?>" disabled>Edit</button>
                                                <?php } else { ?>
                                                <button type='button' class='btn btn-sm btn-warning edit-btn'
                                                ...
                                                <button type='button' class='btn btn-sm btn-danger delete-btn'
                                                    ...
                                                    <?php echo $data['id_dokter'] == $id_dokter ? '' : 'disabled'?>>Delete</button>
                                                <?php } ?>
                                            </td>
